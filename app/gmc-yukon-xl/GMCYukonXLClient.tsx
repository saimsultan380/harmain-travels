    ...
    <div className="min-h-screen bg-[var(--bg)] selection:bg-[var(--gold-soft)] selection:text-[var(--gold)]">
      ...
      <main className="flex-grow overflow-hidden">
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-gradient-to-b from-[var(--gold)]/5 to-[var(--bg)] overflow-hidden flex flex-col justify-center min-h-[85vh]">
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat z-0" style={{ backgroundImage: "url('/images/Reserve Private GMC Taxi in KSA  GMC Ziyarat & Umrah Taxi.png')" }} />
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-stretch">
              ...
              <div className="rounded-[32px] overflow-hidden relative w-full min-h-[400px] h-full">
                <Image
                  src="/images/GMC Yukon XL Taxi Service in Saudi Arabia.png"
                  alt="GMC Yukon XL Taxi Service in Saudi Arabia"
                  fill
