      ...
      <main className="flex-grow overflow-hidden">
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[var(--bg)] overflow-hidden flex flex-col justify-center min-h-[85vh]">
          <div
            ...
            style={{ backgroundImage: "url('/images/zamzam-water-bottles-distribution.webp')" }}
          />
        ...
        <AnimatedSection className="py-24">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-stretch">
              <ImagePlaceholder
                label={t("waterDistribution.charityTitle")}
                imageUrl="/images/water-zamzam-charity-distribution.webp"
              />
        ...
        <AnimatedSection className="py-24 bg-[var(--bg-alt)]/50 border-y border-[var(--border)]">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-stretch">
              ...
              <ImagePlaceholder
                label={t("waterDistribution.ramadanTitle")}
                imageUrl="/images/exclusive-zamzam-water-ramadan.webp"
              />
            </div>
          </div>
        </AnimatedSection>
