...
import { BookOpen, Users, Heart, ArrowRight, Building, FileText, Package, Utensils, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <div className="relative">
          ...
          >
            {services.map((service, i) => {
              ...
              return (
                <div key={i} className="snap-center flex-shrink-0 w-[calc(100vw-2rem)] sm:w-[280px] md:w-[300px] px-2 sm:px-0">
                  <motion.div
